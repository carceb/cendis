...
//=========================================================================================================================
-->
<script language="JavaScript" type="text/JavaScript" src="../controlador/motivo_rechazo_catalogo.js"></script>
<form name="form1" method="post" action="" />
    <table width="410" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
        ...
        <tr class="titulo_catalogo">
            <td height="22" colspan="2" align="center">Catalogo de Motivos de Rechazo </td>
        </tr>
        <tr>
            <td width="150" height="22" align="right">Nombre Motivo Rechazo:</td>
            <td width="250"><input name="txt_nombre_motivo_rechazoVM" type="text" id="txt_nombre_motivo_rechazoVM" size="25" class="input" /></td>
        </tr>
        <tr>
