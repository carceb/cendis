...
<script type="text/JavaScript" src="../controlador/permisos.js"></script>
	...
	<tr>
        <td valign="top" style="overflow:auto;">
			<div  style="overflow:auto;height:400px;">
				<table id="grilla_permisos" cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr style="background-color:#333333;font-weight:bold;text-align:center;color:#FFFFFF;">
						<td colspan="8">LISTADO DE FORMULARIOS Y PERMISOS </td>
					</tr>
					<tr style="background-color:#666666;color:#FFFFFF;font-weight:bold;">
						<td style="width:30%">&nbsp;Formulario</td>
						<td style="width:10%">&nbsp;Ingresar</td>
						<td style="width:10%">&nbsp;Incluir</td>
						<td style="width:10%">&nbsp;Consultar</td>
						<td style="width:10%">&nbsp;Modificar</td>
						<td style="width:10%">&nbsp;Eliminar</td>
						<td style="width:10%">&nbsp;Imprimir</td>
						<td style="width:10%">&nbsp;Listar</td>
					</tr>
...
<input type="hidden" name="hid_permisos" id="hid_permisos" />
