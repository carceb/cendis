...
<script type="text/JavaScript" src="../controlador/motivo_rechazo.js"></script>
...
<table id="formulario" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <td valign="top">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">       
            ...
            <tr>
                <td width="30%" align="right" class="etiqueta"><label for="txt_motivo_rechazo"><span class="Estilo1">*</span> Nombre Motivo Rechazo:</label></td>
                <td><input name="txt_motivo_rechazo" type="text" class="input" id="txt_motivo_rechazo" maxlength="520" />
...
<input type="hidden" name="hid_motivo_rechazo" id="hid_motivo_rechazo" />
