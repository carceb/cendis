...
//=========================================================================================================================
-->
<script language="JavaScript" type="text/JavaScript" src="../controlador/tipo_formato_catalogo.js"></script>
<form name="form1" method="post" action="" />
    <table width="410" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
        ...
        <tr class="titulo_catalogo">
            <td height="22" colspan="2" align="center">Catalogo de Tipos de Formato </td>
        </tr>
        <tr>
            <td width="150" height="22" align="right">Nombre Tipo de Formato:</td>
            <td width="250"><input name="txt_formatoVM" type="text" id="txt_formatoVM" size="25" class="input" /></td>
        </tr>
        <tr>
