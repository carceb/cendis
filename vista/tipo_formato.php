...
<script type="text/JavaScript" src="../controlador/tipo_formato.js"></script>
...
<table id="formulario" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <td valign="top">
        <table cellpadding="0" cellspacing="0" border="0">       
            ...
            <tr>
                <td width="20%" align="right" class="etiqueta"><label for="txt_tipo_formato"><span class="Estilo1">*</span> Nombre Tipo Formato:</label></td>
                <td width="29%"><input name="txt_tipo_formato" type="text" class="input" id="txt_tipo_formato" maxlength="10" />
...
<input type="hidden" name="hid_tipo_formato_id" id="hid_tipo_formato_id" />
