...
//=========================================================================================================================
-->
<script language="JavaScript" type="text/JavaScript" src="../controlador/proyecto_catalogo.js"></script>
<form name="form1" method="post" action="" />
    <table width="410" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr class="titulo_catalogo">
            <td height="22" colspan="2" align="center">Catalogo de Proyecto </td>
        </tr>
        <tr>
	  ...
	  <table width="400" border="0" class="formato-blanco">
        <tr>
          <td align="center"><input type="button" name="vm_Buscar" id="vm_Buscar" value="Buscar" class="input" /></td>
          <td align="center"><input type="button" name="vm_Limpiar" id="vm_Limpiar" value="Limpiar" alt="Haga para limpiar" title="Haga clic para limpiar" class="input" /></td>
        </tr>
      </table></td>
  </tr>
  </table>
