...
<script type="text/JavaScript" src="../controlador/rechazados.js"></script>
<form>
    ...
    <td valign="top">
        ...
        <table id="rechazados" cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr style="background-color:#333333;font-weight:bold;text-align:center;color:#FFFFFF;">
            	<td colspan="6">RECHAZADOS</td>
            </tr>
		<tr style="background-color:#666666;color:#FFFFFF;font-weight:bold;">
            	<td style="width:10%">&nbsp;Fecha Proyecto</td>
                <td style="width:10%">&nbsp;Tipo Artista</td>
                <td style="width:30%">&nbsp;Artista</td>
                <td style="width:35%">&nbsp;Proyecto</td>
                <td style="width:10%">&nbsp;Motivo Rechazo</td>
                <td style="width:5%">&nbsp;Revisar</td>
            </tr>
	    <tr style="background-color:#CCCCCC;" id="1" class="fila_rechazados">
                ...
                <td id="decision">
                	<a href="#" onclick="ActualizarEstatusProyecto(1)"><div class="like"></div></a>
                </td>
            </tr>
        </table>
		</div>
