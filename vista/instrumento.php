...
<script type="text/JavaScript" src="../controlador/instrumento.js"></script>
...
<table id="formulario" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <td valign="top">
        <table cellpadding="0" cellspacing="0" border="0">       
            ...
            <tr>
                <td width="20%" align="right" class="etiqueta"><label for="txt_instrumento"><span class="Estilo1">*</span> Nombre Instrumento:</label></td>
                <td width="29%"><input type="text" name="txt_instrumento" id="txt_instrumento" class="input" />
...
<input type="hidden" name="hid_instrumento_id" id="hid_instrumento_id" />
