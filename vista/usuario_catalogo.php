...
//=========================================================================================================================
-->
<script language="JavaScript" type="text/JavaScript" src="../controlador/usuario_catalogo.js"></script>
<form name="form1" method="post" action="" />
    <table width="410" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
        ...
        <tr class="titulo_catalogo">
            <td height="22" colspan="2" align="center">Catalogo de Grupo </td>
        </tr>
        <tr>
          <td height="22" colspan="2" align="center">Ingrese Usuario, Nombre, Apellido, Cedula Identida o Pasaporte </td>
        </tr>
        <tr>
            <td width="150" height="22" align="right">&nbsp;</td>
            <td width="250"><input name="txt_todoVM" type="text" id="txt_todoVM" size="25" class="input" /></td>
        </tr>
        <tr>
