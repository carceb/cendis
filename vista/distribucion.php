...
<script type="text/JavaScript" src="../controlador/distribucion.js"></script>
...
<table id="formulario" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <td valign="top">
		...
		<table width="835px" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
				<td><label id="recibido_fecha" style="text-align:center" class="recibido_fecha"></label></td>
				<td><input type="checkbox" name="lista_requisito" id="ckb_recibido" class="input" /></td>
				<td><label for="ckb_recibido" style="width:auto;text-align:left;font-size:11px;">RECIBIDO</label></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
		  </tr>
		  <tr>
				<td><label id="estuchado_fecha" style="text-align:center" class="label_fecha"></label></td>
				<td><input type="checkbox" name="lista_requisito" id="ckb_estuchado" class="input" /></td>
				<td><label for="ckb_estuchado" style="width:auto;text-align:left;font-size:11px;">ESTUCHADO</label></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
		  </tr>
		  <tr>
				<td><label id="distribuido_fecha" style="text-align:center" class="label_fecha"></label></td>
				<td><input type="checkbox" name="lista_requisito" id="ckb_distribuido" class="input" style="text-align:right;" /></td>
				<td><label for="ckb_distribuido" style="width:auto;text-align:left;font-size:11px;">DISTRIBUIDO</label></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
		  </tr>
		</table>
...
<input type="hidden" name="hid_distribucion" id="hid_distribucion" />
