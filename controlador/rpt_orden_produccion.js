$(document).ready(function(){
    ...
    AcceVent();
    ocultarIconos();
    $('#titulo').html('Reporte de Orden de Producción');
    ...
    $('#iconImprimir').click(function(){			  
        if ($('#hid_proyecto').val()){
            ...
            window.open('../reportes/lanzador_pdf.php?nombre_reporte=rpt_orden_produccion&TITULO=PRUEBA&SQL_WHERE='+sql_criterio,'','menubar=no,toolbar=no,directories=no,location=no, width=100, height=100, scrollbars=yes, top=0, left=0, estatus=no');
        }
    });
