$(document).ready(function(){						   
    ...
    $('#vm_Buscar').click(function(){//busca ál o los registros
        ...
        //loading('cargando');
        $.post("../modelo/cls_grupo.php",{metodo:"cargaGrilla",parametros:creaParametrosvm()},function(data){//se ejecula la básqueda.
            //alert(data);
            //loading_cerrar();
            if(data.filas){//si trae resultado, entra.
                ...
                $.each(data.filas, function(cant_reg,detalle){//se recorre el json.
                    ...
                    var str = detalle.grupo_id+",'"+detalle.nombre_grupo+"','"+detalle.descripcion_grupo+"'";
...
function aceptar(grupo_id,nombre_grupo,descripcion_grupo){//se carga los datos en formulario que los solicitá al clicar en el registro solicitado y cierra el catálogo.
    montarDatosGrupo(grupo_id,nombre_grupo,descripcion_grupo);
    close_form();
}
